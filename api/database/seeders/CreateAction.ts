  ...
  public async run() {
    await Action.createMany([
      ...
      },
      {
        ...
        'level': '15',
        'url': '/actions/13',
        'description': 'Deals unactionAspectIded damage with a potency of 100. Additional Effect: 20 % chance potency will double',
        'actionTypeId': 2,
        'actionElementId': 4,
        'actionTargetId': 1,
        'actionAspectId': 1,
      ...
      },
      {
        ...
        'level': '70',
        'url': '/actions/16',
        'description': 'Deals unactionAspectIded damage to target and all enemies nearby it with a potency of 560 for the first enemy, and 60% less for all remaining enemies. Polyglot Cost: 1',
        'actionTypeId': 2,
        'actionElementId': 4,
        'actionTargetId': 2,
        'actionAspectId': 1,
      ...
      },
      {
        ...
        'level': '80',
        'url': '/actions/19',
        'description': 'Deals unactionAspectIded damage with a potency of 760. Polyglot Cost: 1',
        'actionTypeId': 2,
        'actionElementId': 4,
        'actionTargetId': 1,
        'actionAspectId': 1,
